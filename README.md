...
If this is your first time using an nf-core pipeline on stanage. you will need to install miniconda and nf-core before you can perform any analysis.
...
[3) Inerpreting and plotting data](https://github.com/OLaingShef/NF-CORE_LPWGS_analysis/blob/main/Interpreting_plotting.md)
